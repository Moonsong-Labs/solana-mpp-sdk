    ...
    <div style={{ ...s.layout, ...(compact ? s.layoutCompact : {}) }}>
      <aside style={{ ...s.sidebar, ...(compact ? s.sidebarCompact : {}) }}>
        <div style={s.sidebarHeader}>
          <div style={s.title}>Session Demo</div>
        ...
        <div style={s.sidebarBottom}>
          ...
          <div style={{ ...s.infoCard, marginTop: 10 }}>
            ...
            <div style={s.valueMuted}>
              {balances ? balances.usdc.toFixed(2) : "--"} USDC
            </div>
            <button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  addLog(
                    `Faucet failed: ${err?.message ?? String(err)}`,
                    "error",
                  );
                } finally {
        ...
        <div ref={logRef} style={s.terminal}>
          {logs.length === 0 && (
            <div style={s.emptyLog}>
              Initialize Swig and send a request to observe open and update
              events.
            </div>
          )}
          {logs.map((line) => (
